<script>
    import RSVP from "$lib/landing/RSVP.svelte";
...
<div class="h-screen bg-primary-container w-full sticky top-0">
    <div class="h-screen w-full flex flex-col items-center justify-center scale-[0.85] bg-surface landing-page-container p-2 overflow-hidden pb-24 pt-12 md:hidden">
        ...
        <div class="w-[80%] sm:w-[45%] h-fit py-2 rounded-t-xl flex flex-col items-center justify-center bg-on-surface overflow-hidden -rotate-3 origin-bottom-left">
            <div class="w-full h-fit p-2 flex flex-row items-center justify-center relative">
                <p class="text-sm primary-font text-surface capitalize text-center flex flex-row items-center justify-center">
                    Connecting <span class="brand-font text-lg">Ideas</span>, Creating
                    <span class="brand-font text-lg">Futures</span>
                </p>
        ...
        <div class="w-[78%] sm:w-[45%] h-screen max-h-[500px] py-2 rounded-b-xl flex flex-col bg-on-surface z-[3]">
            <div class="w-full h-full relative flex flex-col items-center justify-center">
                ...
                <div class="h-full w-full flex flex-col items-center justify-center gap-2 px-4">
                    <p class="text-xl text-center primary-font text-surface">You Have Been <br> <span
                            class="brand-font text-2xl">Invited!</span></p>
                    <div class="h-fit w-fit flex flex-col items-center justify-center gap-2">
                        <div class="text-[3.4rem] primary-font font-bold flex flex-row text-primary-container text-center h-fit w-fit overflow-hidden landing-branch-name leading-[1] tracking-tight">
                            <span class="landing-branch-letter-1 translate-y-[100px]">I</span><span
                                ...
                                class="landing-branch-letter-3 translate-y-[900px]">E</span>
                            <span class="landing-branch-letter-4 translate-y-[1300px]">E</span>
                        </div>
                        <div class="text-[3.4rem] primary-font font-bold text-primary-container -mt-4 text-center flex flex-col leading-[1] tracking-tight">
                            <div class="w-fit h-fit flex flex-row overflow-hidden">
                                <span class="landing-society-letter-1 translate-y-[100px]">S</span><span
                                    ...
                                    class="landing-society-letter-3 translate-y-[500px]">C</span>
                                <span class="landing-society-letter-4 translate-y-[900px]">I</span><span
                                    class="landing-society-letter-5 translate-y-[1300px]">E</span><span
                                    class="landing-society-letter-6 translate-y-[1700px]">T</span>
                                <span class="landing-society-letter-7 translate-y-[2100px]">Y</span>
                            </div>
                        </div>
                    </div>
                    <div class="h-fit w-[105%] bg-tertiary-container text-on-tertiary-container -rotate-3 origin-bottom-left py-1 px-4 flex items-center justify-center landing-student-ribbon">
                        <p class="text-2xl font-bold primary-font">
                            Student Branch
                        </p>
                    </div>
    ...
    <div class="h-screen w-full invisible md:visible md:flex flex-col items-center justify-center scale-[0.85] bg-surface landing-page-container relative p-2 overflow-hidden pb-28 pt-4 px-4">
        ...
        <div class="min-h-fit w-[85%] min-[900px]:w-[70%] lg:w-[65%] xl:w-[55%] 2xl:w-[47%] flex flex-row items-center justify-start z-[5]">
            ...
            <div class="w-full bg-on-surface rounded-r-xl relative flex flex-col items-center justify-center pb-4 px-4 pt-4">
                ...
                <p class="text-2xl lg:text-3xl primary-font text-surface capitalize text-center flex flex-row items-center justify-center">
                    CONNECTING <span class="brand-font text-2xl">Ideas</span>, CREATING
